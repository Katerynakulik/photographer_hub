...
def add_to_cart(request, item_id):
    ...
    if item_type == 'session':
        ...
        if item_key in cart:
            ...
            cart[item_key] = 1
            messages.success(
                request, f"Success! {display_name} added to your cart.")
        ...
        if item_key not in cart:
            cart[item_key] = 1
            messages.success(
                request, f"Digital license for {display_name} added to your cart.")
        else:
            messages.info(
                request, "This license is already in your cart (limit 1).")
